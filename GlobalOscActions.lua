...
add_global_action { 
  pattern = "/song/pattern/length", 
  description = "Set current pattern length",
  
  arguments = { argument("number_of_lines", "number") },
  handler = function(number_of_lines)
    song().selected_pattern.number_of_lines = clamp_value(number_of_lines, 1, renoise.Pattern.MAX_NUMBER_OF_LINES)
  end
}
